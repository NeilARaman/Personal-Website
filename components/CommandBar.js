...
const CommandBarClient = (props) => {
  ...
  const copyLink = async () => {
    ...
    try {
      ...
      if (navigator.clipboard && navigator.clipboard.writeText) {
        await navigator.clipboard.writeText('https://neilraman.com')
        setShowToast(true)
      } else if (document && document.execCommand) {
        // Fallback for older browsers
        const textArea = document.createElement('textarea')
        textArea.value = 'https://neilraman.com'
        ...
        // Still show toast to let user know we tried
        setShowToast(true)
      }
    } catch (err) {
      console.error('Failed to copy to clipboard:', err)
      // Still show toast to indicate the action was attempted
      setShowToast(true)
    }
  }
  ...
  const actions = [
    ...
    },
    {
      ...
      section: 'Go To',
      perform: () => router.push('/'),
      icon: <LottieIcon lottieRef={homeRef} style={iconSize} animationData={homeIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'about',
      name: 'About',
      ...
      icon: <LottieIcon lottieRef={aboutRef} style={iconSize} animationData={aboutIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'articles',
      name: 'Articles',
      ...
      icon: <LottieIcon lottieRef={articlesRef} style={iconSize} animationData={articlesIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'projects',
      name: 'Projects',
    ...
    },
    {
      ...
      icon: <LottieIcon lottieRef={toolsRef} style={iconSize} animationData={usesIcon} loop={false} autoplay={false} />,
    },
    // {
    //   id: 'talks',
    //   name: 'Talks',
    ...
    //   icon: <LottieIcon lottieRef={talksRef} style={iconSize} animationData={talksIcon} loop={false} autoplay={false} />,
    // },
    // {
    //   id: 'podcasts',
    //   name: 'Podcasts',
    ...
    //   icon: <LottieIcon lottieRef={usesRef} style={iconSize} animationData={usesIcon} loop={false} autoplay={false} />,
    // },
    // {
    //   id: 'reminder',
    //   name: 'Reminder',
    ...
    //   icon: <LottieIcon lottieRef={reminderRef} style={iconSize} animationData={reminderIcon} loop={false} autoplay={false} />,
    // },
    {
      id: 'contact',
      name: 'Contact',
...
const DynamicCommandBar = dynamic(() => Promise.resolve(CommandBarClient), { ssr: false })

export default function CommandBar(props) {
  return <DynamicCommandBar {...props} />
}
